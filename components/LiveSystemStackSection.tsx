...
export function LiveSystemStackSection() {
  return (
    <section id="systems" className="relative overflow-hidden py-24 lg:py-32">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-orange/8 blur-[100px]" />
                  ...
                  <div key={node.label} className="flex flex-1 items-center">
                    <div className="group relative flex w-full flex-col items-center">
                      <div className="gradient-border w-full max-w-[148px] rounded-2xl glass-card glass-card-hover px-3 py-5 text-center shadow-lg shadow-black/20">
                        <div className="mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-xl bg-brand-orange/10 ring-1 ring-brand-orange/25 transition-all group-hover:bg-brand-orange/15 group-hover:ring-brand-orange/40">
                      ...
                      {!isLast && (
                        <div
                          ...
                          aria-hidden="true"
                        >
                          <div className="flow-line h-px flex-1 bg-gradient-to-r from-brand-orange/60 via-brand-orange/30 to-brand-orange/60" />
                          <ArrowRight className="mx-1 h-3.5 w-3.5 shrink-0 text-brand-orange/70" />
                        </div>
                      )}
                    </div>
                  </div>

...
import { configuratorOptions } from "@/lib/intake";
    ...
    <section id="configurator" className="relative py-20 lg:py-28">
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
        <SectionHeading
          ...
          subtitle="Tap a chip to jump straight to the project form."
        />
        ...
        <p className="mt-8 flex items-center justify-center gap-2 text-center text-sm text-zinc-500">
          ...
          Selecting a chip scrolls you straight to the project form below.
        </p>
      </div>
    </section>
  );

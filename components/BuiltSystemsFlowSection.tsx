...
export function BuiltSystemsFlowSection() {
  return (
    <section id="built-systems" className="relative overflow-hidden py-24 lg:py-32">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-px w-2/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-brand-gold/40 to-transparent" />
                ...
                return (
                  <div key={step.label} className="flex flex-1 items-center">
                    <div className="group relative flex w-full flex-col items-center">
                      <div className="gradient-border w-full max-w-[160px] rounded-2xl glass-card px-3 py-5 text-center transition-all duration-300 hover:shadow-lg hover:shadow-brand-gold/10">
                        <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-brand-gold/10 ring-1 ring-brand-gold/25 transition-all group-hover:bg-brand-gold/15 group-hover:ring-brand-gold/40">
                      ...
                      {!isLast && (
                        <div
                          ...
                          aria-hidden="true"
                        >
                          <div className="flow-line h-px flex-1 bg-gradient-to-r from-brand-gold/50 to-brand-gold/20" />
                          <ArrowRight className="mx-0.5 h-4 w-4 shrink-0 text-brand-gold/60" />
                        </div>
                      )}
                    </div>
                  </div>
